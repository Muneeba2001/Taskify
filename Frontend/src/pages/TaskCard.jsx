...
import { Grid, Card, CardContent, Typography, Box, Modal, Button } from '@mui/material';
    ...
    <div style={{ marginTop: '30px' }}>
      ...
      <Grid container spacing={3} justifyContent="center">
        {tasks.map((task, index) => (
          <Grid item xs={12} sm={4} md={2} key={index}>
            <Card sx={{ minHeight: '150px', borderRadius: '10px', backgroundColor: '#fff', boxShadow: 3 }}>
              <CardContent sx={{ textAlign: 'center', padding: '16px' }} onClick={() => onClickTask(task)}>
      ...
      <Modal open={open} onClose={handleClose}>
        <Box sx={{
          ...
          backgroundColor: 'white', padding: '20px', borderRadius: '10px', boxShadow: 3,
          width: '80%', maxWidth: '600px', overflowY: 'auto', maxHeight: '90vh',
        }}>
          {selectedTask && (
            <div>
              ...
              <Button variant="contained" sx={{ backgroundColor: '#654F90', marginTop: '10px' }} onClick={handleClose}>
                Close
              </Button>
            </div>
          )}
